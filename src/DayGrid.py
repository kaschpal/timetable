...
class CalendarButton(Gtk.Button):
    ...
    def __init__(self, parent):
        ...
        vbox.append(self.__calView)
        vbox.set_margin_top(10)
        vbox.set_margin_bottom(10)
        vbox.set_margin_start(10)
        vbox.set_margin_end(10)
        self.__popover.set_child(vbox)
    ...
    def __togglePopup(self, button):
        ...
        self.__popover.set_parent(button)
    ...
    def __setEmpty(self):
        ...
        if self.__current_image is not None:
            self.set_child(None)
        self.set_child(self.__empty_image)
    ...
    def __setNotEmpty(self):
        ...
        if self.__current_image is not None:
            self.set_child(None)
        self.set_child(self.__not_empty_image)
